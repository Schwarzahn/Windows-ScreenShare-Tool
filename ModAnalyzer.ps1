...
<#
.SYNOPSIS
  ScreenShare Tool — Mod Analyzer (Meow + Habibi features: Modrinth/Megabase/strings).
  by Schwarzahn
#>
...
Clear-Host
Write-BloodBanner -Subtitle 'Mod Analyzer'
Write-Section 'MODS PATH'
...
Write-Host "https://github.com/Schwarzahn" -ForegroundColor DarkGray
Write-Host "                 " -NoNewline
...
Write-BloodFoot -Subtitle 'Mod Analyzer'
